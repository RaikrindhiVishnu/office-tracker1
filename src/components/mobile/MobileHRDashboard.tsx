...
export const MobileHRDashboard: React.FC = () => {
      ...
      <main className={["home"].includes(activeTab) ? "w-full pb-20" : "w-full px-0 pt-4 max-w-lg mx-auto flex flex-col pb-20"}>
          ...
          <div className="flex flex-col bg-[#f4f5f7] min-h-screen">
            ...
            <div className="bg-[#e0e7ff] px-3 pb-3 flex gap-2 overflow-x-auto hide-scrollbar">
              {([
                ...
                { label: "My Reg", tab: "my-regularization", icon: "⏱️" },
              ] as const).map((item) => (
                <button
                  key={item.tab}
        ...
        {activeTab === "monthly" && (
          <div className="w-full flex-1">
            <div className="bg-indigo-600 px-5 pt-12 pb-6 text-white mb-[-20px] rounded-b-[32px] shadow-lg relative z-10">
              <h2 className="text-2xl font-black mb-1">Attendance Reports</h2>
              <p className="text-indigo-200 text-sm font-medium">Monthly views & statistics</p>
            </div>
            <div className="px-3">
              <MonthlyReport db={db} users={users} monthlyDate={monthlyDate} setMonthlyDate={setMonthlyDate} monthlyAttendance={monthlyAttendance} setMonthlyAttendance={setMonthlyAttendance} sessionsByDate={{}} isHoliday={isHoliday} saveMonthlyAttendance={saveMonthlyAttendance} getAutoStatus={getAutoStatus} isSunday={isSunday} isSecondSaturday={isSecondSaturday} isFourthSaturday={isFourthSaturday} isFifthSaturday={isFifthSaturday} />
            </div>
          </div>
        )}
        ...
        {activeTab === "my-regularization" && (
          <div className="w-full flex-1">
            <div className="bg-indigo-600 px-5 pt-12 pb-6 text-white mb-[-20px] rounded-b-[32px] shadow-lg relative z-10">
              <h2 className="text-2xl font-black mb-1">My Regularization</h2>
              <p className="text-indigo-200 text-sm font-medium">Apply for missed check-ins</p>
            </div>
            <div className="px-3 pt-6 bg-white min-h-[70vh] rounded-t-[32px]">
