...
import AdminDailyReflectionsView from "./AdminDailyReflectionsView";
    ...
    <div className="h-screen flex bg-linear-to-br from-slate-50 via-slate-100 to-slate-50 overflow-hidden">
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto py-2 space-y-0.5 custom-scrollbar">
          ...
          <NavItem
            ...
            label="Daily Reflections" active={view === "daily-reflections"}
            onClick={() => { setView("daily-reflections"); setSidebarOpen(false); }} collapsed={sidebarCollapsed}
          />
      ...
      <div className={`${sidebarCollapsed ? "lg:ml-20" : "lg:ml-64"} flex-1 flex flex-col h-screen transition-all duration-300 overflow-hidden`}>
        ...
        <main className={`flex-1 overflow-auto bg-slate-50 px-4 pb-4 pt-2 lg:px-8 lg:pb-8 lg:pt-4 space-y-4`}>
          ...
          {view === "daily-reflections" && <AdminDailyReflectionsView />}
