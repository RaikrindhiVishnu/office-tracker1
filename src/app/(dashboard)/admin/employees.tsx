                ...
                <div className="flex flex-col sm:flex-row items-start gap-6 -mt-16 mb-6">
                  ...
                  <div className="flex-1 pt-16 sm:pt-20">
                    ...
                    <div className="flex flex-wrap gap-3">
                      <span className={`px-4 py-2 rounded-xl text-sm font-bold shadow-sm ${selectedEmployee.status === "ONLINE" ? "bg-emerald-100 text-emerald-700" : "bg-slate-200 text-slate-600"
                        }`}>
        ...
        {showAddUser && (
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative z-10 w-full max-w-md bg-white rounded-2xl shadow-2xl p-7 animate-[popup_.18s_ease]">
              ...
              {/* Message */}
              {msg && (
                <p className={`mb-4 text-sm font-medium p-3 rounded-lg ${msg.startsWith("✅")
